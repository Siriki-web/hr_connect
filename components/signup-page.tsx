...
export function SignupPageComponent() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      <div className="flex-1 flex flex-col justify-center px-1 sm:px-3 lg:px-1 py-4 bg-gray-100 ml-20">
          ...
          <ul className="space-y-2 mb-8">
            {features.map((feature, index) => (
              <li key={index} className="flex items-center">
                <CheckIcon className="h-5 w-5 text-teal-500 mr-2" />
                <span>{feature}</span>
              </li>
            ))}
          </ul>
      ...
      <div className="flex-1 flex flex-col justify-center px-2 sm:px-4 lg:px-12 xl:px-16 w-full max-w-2xl mr-20">
